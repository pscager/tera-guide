...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-735-1000-104-0": [{ type: "text", sub_type: "message", message: "Front Clip", message_RU: "Передний зажим" }],
		"s-735-1000-108-0": [{ type: "text", sub_type: "message", message: "Get Out", message_RU: "От него" }], // крутилка
		...
		"s-735-3000-125-0": [{ type: "text", sub_type: "message", message: "Front", message_RU: "Удар вперед" }],
		"s-735-3000-126-0": [{ type: "text", sub_type: "message", message: "Front | Back", message_RU: "Удар вперед | Удар назад" }],
		"s-735-3000-127-0": [{ type: "text", sub_type: "message", message: "Back", message_RU: "Удар назад" }],
		"s-735-3000-128-0": [
