...
module.exports = (dispatch, handlers, guide, lang) => {
	return {
		...
		"s-794-3000-125-0": [{ type: "text", sub_type: "message", message: "Bait", message_RU: "Байт" }],
		"s-794-3000-315-0": [{ type: "text", sub_type: "message", message: "Pull", message_RU: "Стяжка" }],
		"s-794-3000-316-0": "s-794-3000-315-0"
	};
};